from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QTextEdit, QProgressBar
...
class KaraokeController:
    ...
    def toggle_recording(self):
        ...
        if not self.recording:
            ...
            sd.stop()
            self.view.show_message("Recording stopped")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("="*60 + "\n")
        print("Console mode: Application loaded successfully!")
